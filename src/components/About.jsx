...
import resume from "../resume/Resume-Sanchit-Handa.pdf"
import AOS from "aos";
...
export default function About() {
      ...
      <div>
        <div data-aos="fade-up" className=" first">
          <p id="user-detail-intro">
            Welcome to where I turn coffee into code! I'm Sanchit,
 ...
 with a passion for building websites that not only look great but also make users say, <p style={{display:'inline-block'}} className="sauce">'Wow, this is awesome!' </p> &nbsp; 
        ...
        <a onClick={handleDownload} rel="noreferrer" href={resume} download={"Resume-Sanchit-Handa"} id="resume-button-2" className="contact-button resume-button second-btn">Resume</a>
      </div>
    </section>
  );
}
